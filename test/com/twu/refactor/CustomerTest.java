...
public class CustomerTest extends TestCase {
    ...
    public void testEmpty() throws Exception {
        ...
        equalsFile("1st Output", "outputEmpty", Customer.statement(dinsdale));
    }
    public void testCustomer() throws Exception {
        equalsFile("1st Output", "output1", Customer.statement(dinsdale));
    }

    public void testChange() throws Exception {
    	la.setPriceCode(Movie.REGULAR);
        equalsFile("1st Output", "outputChange", Customer.statement(dinsdale));
    }
